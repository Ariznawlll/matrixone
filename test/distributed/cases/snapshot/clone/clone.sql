...
select datname,dat_catalog_name,dat_createsql,account_id from mo_catalog_new.mo_database where datname = 'test01';
create database mo_catalog_new_new clone mo_catalog {snapshot = 'sp04'};
select datname,dat_catalog_name,dat_createsql,account_id from mo_catalog_new_new.mo_database where datname = 'test01' or datname = 'test02' or datname = 'test03';
drop database if exists mo_catalog_new01;
create database mo_catalog_new01 clone mo_catalog_new;
select datname,dat_catalog_name,dat_createsql,account_id from mo_catalog_new01.mo_database where datname = 'test01';
...
select datname,dat_catalog_name,dat_createsql,account_id from mo_catalog_new_new01.mo_database where datname = 'test01';
